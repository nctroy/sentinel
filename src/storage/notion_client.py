...
class NotionClient:
    ...
    def create_bottleneck_page(self, parent_page_id: str, agent_id: str,
                                bottleneck: Dict[str, Any]) -> Optional[str]:
                ...
                children=[
                    {
                        ...
                        "type": "heading_2",
                        "heading_2": {
                            "rich_text": [{"type": "text", "text": {"content": "Bottleneck Details"}}]
                        }
                    },
                    {
                        "object": "block",
                        ...
                        "paragraph": {
                            "rich_text": [
                                {"type": "text", "text": {"content": f"Agent: {agent_id}\n"}, "annotations": {"bold": True}},
                                {"type": "text", "text": {"content": f"Impact Score: {bottleneck['impact_score']}/10\n"}},
                                {"type": "text", "text": {"content": f"Confidence: {bottleneck['confidence']:.0%}\n"}},
                            ]
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "type": "paragraph",
                        "paragraph": {
                            "rich_text": [{"type": "text", "text": {"content": bottleneck['description']}}]
                        }
                    },
                    {
                        "object": "block",
                    ...
                    },
                    {
                        ...
                        "type": "paragraph",
                        "paragraph": {
                            "rich_text": [{"type": "text", "text": {"content": bottleneck.get('recommended_action', 'None specified')}}]
                        }
                    },
                    {
                        "object": "block",
                    ...
                    },
                    {
                        ...
                        "type": "callout",
                        "callout": {
                            "rich_text": [{"type": "text", "text": {"content": f"Created by Sentinel on {datetime.now().strftime('%Y-%m-%d %H:%M')}"}}],
                            "icon": {"emoji": "🤖"}
                        }
                    }
                ]
    ...
    def _create_database(self, parent_page_id: str, title: str, properties: Dict) -> str:
    ...
    async def create_agent_database(self, agent_name: str) -> str:
        ...
        logger.warning("create_agent_database is deprecated. Use setup_dashboard instead.")
        return ""
