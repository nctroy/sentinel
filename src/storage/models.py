...
class Agent(Base):
    ...
    # Relationships
    bottlenecks = relationship("Bottleneck", back_populates="agent", cascade="all, delete-orphan")
...
class Action(Base):
    ...
    status = Column(String(50), default='queued')  # queued, executing, completed, failed
...
class DecisionLog(Base):
    ...
    decision_type = Column(String(100), nullable=False)  # bottleneck_identified, action_executed, etc.
